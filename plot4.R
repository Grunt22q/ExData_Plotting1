...
globalReactivePower <- as.numeric(table1$Global_reactive_power)

voltage <- as.numeric(table1$Voltage)

subMetering1 <- as.numeric(table1$Sub_metering_1)

subMetering2 <- as.numeric(table1$Sub_metering_2)

subMetering3 <- as.numeric(table1$Sub_metering_3)
